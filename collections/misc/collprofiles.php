...
<body>
	...
	<div id="innertext">
		...
		if($collid){
			...
			$codeStr = ' (';
            if($collData['institutioncode']) $codeStr .= $collData['institutioncode'];
            if($collData['institutioncode'] && $collData['collectioncode']) $codeStr .= '-';
			...
			<div style='margin:10px;'>
				...
				<div style="clear:both;margin-top:5px;">
					<div style="font-weight:bold;">Database Statistics:</div>
