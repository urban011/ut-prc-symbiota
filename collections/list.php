...
$occFieldArr = array('occurrenceid','family', 'scientificname', 'sciname', 
	...
	'country', 'stateprovince', 'county', 'municipality', 'locality', 'previous_determinations',
		...
		<div id="speclist">
			...
			elseif($specimenArray){
			    ...
			    foreach($specimenArray as $collId => $specData){
                    ...
                    if(!empty($collectionArr[$collId]['instcode'])) $instCode1 = $collectionArr[$collId]['instcode'];
                    if(!empty($collectionArr[$collId]['instcode']) && $collectionArr[$collId]['collcode']) $instCode1 .= ":";
