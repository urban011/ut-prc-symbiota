...
<head>
    ...
    <script>
        $( document ).ready(function() { // onDomReady
            ...
            $('form[name="harvestparams"] input:reset').click(function () {
                $('form[name="harvestparams"]')
...
<?php
	...
	<div id="innertext">
		...
		<form name="harvestparams" id="harvestparams" action="list.php" method="post" onsubmit="return checkForm()">
            ...
            <div>
                Previous Determinations: <input type="text" id="previous_determinations" size="43" name="previous_determinations" value="<?php if(array_key_exists("previous_determinations",$collArray)) echo $collArray["previous_determinations"]; ?>" />
            </div>
			<div style="margin:10 0 10 0;"><hr></div>
			<div>
